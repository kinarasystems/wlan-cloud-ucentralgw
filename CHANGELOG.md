...
- Kinara customizations preserved: fixedconfig/cablediagnostics/compressedconfig device commands, RBAC security objects, AWS ECR build/deploy workflow, helm/values, buildit/buildaws scripts
